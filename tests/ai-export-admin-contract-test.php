...
ai_export_admin_assert(false !== strpos($hub, "'slug'        => 'aihl-ai-export'"), 'Pagina Esporta per AI non registrata.');
ai_export_admin_assert(strpos($hub, "'aihl-ai-export' =>") < strpos($hub, "'aihl-api-keys' =>"), 'Esporta per AI deve precedere Accesso API.');
ai_export_admin_assert(false !== strpos($export, 'admin_post_aihl_download_ai_context'), 'Handler download export assente.');
