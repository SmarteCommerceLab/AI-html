...
function aihl_ai_openapi_route_metadata(): array {
	return array(
		...
		'/aihtml/v1/ai/canvas' => array('summary' => 'Read or select Canvas sources for header and footer', 'tag' => 'Canvas', 'read_schema' => 'CanvasPayload', 'write_schema' => 'CanvasRequest'),
		...
		'components' => array(
			...
			'schemas' => array(
				...
				'CanvasPayload' => array(
					'type' => 'object',
					'additionalProperties' => false,
					'required' => array('header', 'footer'),
					'properties' => array(
						'header' => array('$ref' => '#/components/schemas/CanvasAreaState'),
						'footer' => array('$ref' => '#/components/schemas/CanvasAreaState'),
					),
				),
				'CanvasAreaState' => array(
					'type' => 'object',
					'additionalProperties' => false,
					'required' => array('mode', 'selected_slot_id', 'resolved_slot_id', 'available', 'health'),
					'properties' => array(
						'mode' => array('type' => 'string', 'enum' => array('native', 'canvas')),
						'selected_slot_id' => array('type' => 'string'),
						'resolved_slot_id' => array('type' => 'string'),
						'available' => array('type' => 'boolean'),
						'health' => array('$ref' => '#/components/schemas/CanvasHealth'),
					),
				),
				'CanvasHealth' => array(
					'type' => 'object',
					...
					'properties' => array(
						...
						'mode' => array('type' => 'string', 'enum' => array('native', 'canvas')),
						'status' => array('type' => 'string', 'enum' => array('ok', 'warning', 'error', 'inactive')),
						'selected_slot_id' => array('type' => 'string'),
						'resolved_slot_id' => array('type' => 'string'),
						'editor_slot_id' => array('type' => 'string'),
				...
				'CanvasHealthIssue' => array(
					'type' => 'object',
					'additionalProperties' => false,
					'required' => array('code', 'severity', 'message'),
					'properties' => array(
						'code' => array('type' => 'string'),
						'severity' => array('type' => 'string', 'enum' => array('warning', 'error')),
...
function aihl_ai_rest_create_page(WP_REST_Request $request) {
	...
	return rest_ensure_response(array(
		...
		'edit_builder' => in_array($template, array('smart-site-home.php', 'smart-site-builder.php', 'smart-site-blog.php'), true)
