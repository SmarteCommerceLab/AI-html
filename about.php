...
<main id="main" class="site-main">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6" data-sbin-motion-recipe="image-clip-reveal" data-sbin-motion-target="media">
                    <div class="position-relative overflow-hidden h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100 pt-5 pe-5" data-sbs-motion-target="media" src="<?php echo esc_url(AIHL_DIR_URL . '/resource/img/about-img.jpg'); ?>" alt="<?php esc_attr_e('Immagine istituzionale', AIHL_TEXT_DOMAIN); ?>" style="object-fit: cover;" loading="eager" decoding="async">
                        <img class="position-absolute top-0 end-0 bg-body ps-2 pb-2" data-sbs-motion-target="media" src="<?php echo esc_url(AIHL_DIR_URL . '/resource/img/bg-about-img.png'); ?>" alt="<?php esc_attr_e('Dettaglio aziendale', AIHL_TEXT_DOMAIN); ?>" style="width: 200px; height: 200px;" loading="lazy" decoding="async">
                    </div>
                </div>
                <div class="col-lg-6" data-sbin-text-reveal="fade-up">
                    <div class="h-100">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" data-sbin-text-reveal="fade-up" style="max-width: 500px;">
            ...
            <div class="row g-4 d-flex justify-content-center">
                <div class="col-lg-3 col-md-6" data-sbin-text-reveal="fade-up">
